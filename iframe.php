        ...
        <div class="row" id="uploadRow">
            ...
            <div class="col-xs-12 col-sm-6 col-md-5 col-lg-4">
		        ...
		        <div align="center" class="share-video embed-responsive embed-responsive-square" style="margin-top: 0;" >
			         <video id="brutalCut" poster="files/cycling-cover.jpg" muted autoplay loop class="embed-responsive-item">
				         <source src="files/example-cycling.mp4" type="video/mp4">Your browser does not support the video tag.</source>
				     </video>
			    	</div>
